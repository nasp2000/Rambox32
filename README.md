...
1. Flash the pre-built binary to your ESP32-S3 N16R8 (binaries in Releases). For future updates use [webflasher_Node32-HUB](https://github.com/nasp2000/webflasher_Node32-HUB)
